...
class ExtractionMethod(str, Enum):
    ...
    POPPLER = "poppler"
    ADOBE_EXTRACT = "adobe"
    AMAZON_TEXTRACT_DETECT = "amazon-detect-text"
    AMAZON_TEXTRACT_ANALYZE = "amazon-analyze-document"
    GOOGLE_DOCAI_OCR = "google-ocr"
    GOOGLE_DOCAI_FORM = "google-form"
    GOOGLE_DOCAI_LAYOUT = "google-layout"
